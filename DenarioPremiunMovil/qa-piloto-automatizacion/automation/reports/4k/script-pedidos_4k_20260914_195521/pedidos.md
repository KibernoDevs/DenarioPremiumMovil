...
- ✅ **DM-PED-017** Cargar cantidad → la línea entra al carrito _(producto "1R1807-4K" en "FILTROS 1" · ⚠ RELEVO — "4400-01202" no apareció en 4 categoría(s): FILTROS 1, INYECCION 3, MISCELANEOS 4, MOTOR 8 · cantidad en pantalla: 2 · líneas en carrito: 1)_
...
- ✅ **DM-PED-030** Guardar pedido → confirma y el pedido queda guardado _(pregunta: "¿Desea guardar el pedido?" [Cancelar/Aceptar] → respuesta: "Pedido Guardado" [OK] · comentario: "Test-PED-123146" · en la BD local: co_order=1789430131540.0, st_delivery=3)_
...
- ✅ **DM-PED-031** Enviar pedido → llega a la nube (y UNA sola fila) _(1 alert(s): ¿Desea Enviar el pedido? [Cancelar/Aceptar] · Nro.Ref: no anunciado · home tras enviar: true · ☁ 1 fila(s) con la marca Test-PED-123146: 2596/1789430131540.0 27.0000 USD st=1 · BD-OK (id_order=2596, st_delivery=1, líneas=1) · payload↔nube: BD-FIELD-OK (1 POST capturado/s))_
