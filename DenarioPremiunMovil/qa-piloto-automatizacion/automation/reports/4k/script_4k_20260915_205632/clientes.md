...
- ✅ **DM-CLT-024** Click Guardar → cliente potencial guardado _(alert btn: "Aceptar"; "Test-CLT-SMOKE-241013" visible en BUSCAR · BD-SAVED(st=0))_
...
- ✅ **DM-CLT-026** Re-abrir Guardado → Enviar → 3 alertas → Enviado _(ref potencial: 99; en home clientes: 3 botones · BD-LOCAL-OK(id=99,st=2) · BD-FIELD-MISMATCH (da_client: payload='2026-09-15 20:58:03' vs nube='2026-09-16T00:58:03.000Z'))_
- ✅ **DM-CLT-031** Borrar cliente Guardado → desaparece de lista _("Test-CLT-DEL-241013" eliminado OK)_
