...
- ✅ **DM-DEP-005** Fecha Doc seleccionada _(fecha: 15/9/2026)_
- ✅ **DM-DEP-006** Nro. Plantilla + cobro → Guardar _(16 cobros; Guardar enabled=true)_
- ✅ **DM-DEP-009** Click Guardar → Guardado _(alert: "Aceptar"; 6 ítems · BD-SAVED(st=3))_
- ✅ **DM-DEP-010** BUSCAR → lista _(6 ítems)_
- ✅ **DM-DEP-014** Click Guardado → form con datos _(Nro.Plantilla: "DEP-QA-424844")_
...
- ✅ **DM-DEP-017** Click Enviar → Enviado _(ref: N/A · BD-LOCAL-OK(id=44,st=1) · BD-FIELD-MISMATCH (da_deposit: payload='2026-09-15 21:00:26' vs nube='2026-09-16T01:00:26.000Z'))_
- ✅ **DM-DEP-018** BUSCAR tras enviar → lista _(6 ítems)_
