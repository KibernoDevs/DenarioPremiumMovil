...
- ✅ **DM-PED-030** Guardar pedido → confirma y el pedido queda guardado _(pregunta: "¿Desea guardar el pedido?" [Cancelar/Aceptar] → respuesta: "Pedido Guardado" [OK] · comentario: "Test-PED-484567" · en la BD local: co_order=1789430493894.0, st_delivery=3)_
...
- ✅ **DM-PED-031** Enviar pedido → llega a la nube (y UNA sola fila) _(1 alert(s): ¿Desea Enviar el pedido? [Cancelar/Aceptar] · Nro.Ref: no anunciado · home tras enviar: true · ☁ 1 fila(s) con la marca Test-PED-484567: 2597/1789430493894.0 27.0000 USD st=1 · BD-OK (id_order=2597, st_delivery=1, líneas=1) · payload↔nube: BD-FIELD-MISMATCH (da_order: payload='2026-09-14 20:02:39' vs nube='2026-09-15T00:02:39.000Z') (2 POST capturado/s))_
- 🚫 **DM-PED-034** BUSCAR -> el searchbar filtra en tiempo real _(la lista no cargo ningun pedido en 12 s (en la pagina: false) - sin items no hay nada que filtrar · pantalla: Pedidos PEDIDO BUSCAR COPIAR)_
- ✅ **DM-PED-035** Abrir un pedido de la lista → formulario rehidratado _(tabs: General · Total · Adjunto · comentario rehidratado: "Test-PED-484567")_
...
- ⬜ **DM-PED-037** Borrar un pedido Guardado desde la lista _(sin botón de borrado en la lista (8 ítem/s): sólo los Guardado lo muestran)_

**Resumen:** PASS:17 · N/A:5 · BLOCKED:1
_Tiempo: 131.6s_