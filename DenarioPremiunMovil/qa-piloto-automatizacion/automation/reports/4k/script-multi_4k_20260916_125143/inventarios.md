...
- ✅ **DM-INV-011** Llenar campos modal _(cantidad: 5; expirationBatch: true; lote: LOTE-QA-8131)_
...
- ✅ **DM-INV-022** Click Enviar → Enviado _(ref: N/A · BD-LOCAL-OK(id=107,st=1) · BD-FIELD-OK)_
- ✅ **DM-INV-023** BUSCAR → lista _(5 ítems)_
- ✅ **DM-INV-025** Searchbar filtra _("C.0398" → 2 resultado(s))_
