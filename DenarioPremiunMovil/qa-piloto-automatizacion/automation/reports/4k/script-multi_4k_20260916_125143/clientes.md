...
- ✅ **DM-CLT-002** Click CLIENTES → lista de clientes _(46 clientes)_
- ✅ **DM-CLT-003** Buscar "A" en lista _(42 resultados)_
...
- ✅ **DM-CLT-024** Click Guardar → cliente potencial guardado _(alert btn: "Aceptar"; "Test-CLT-SMOKE-505692" visible en BUSCAR · BD-SAVED(st=0))_
...
- ✅ **DM-CLT-026** Re-abrir Guardado → Enviar → 3 alertas → Enviado _(ref potencial: 101; en home clientes: 3 botones · BD-LOCAL-OK(id=101,st=2) · BD-FIELD-OK)_
- ✅ **DM-CLT-031** Borrar cliente Guardado → desaparece de lista _("Test-CLT-DEL-505692" eliminado OK)_
