...
- ✅ **DM-CLT-024** Click Guardar → cliente potencial guardado _(alert btn: "Aceptar"; "Test-CLT-SMOKE-647308" visible en BUSCAR · BD-SAVED(st=0))_
...
- ✅ **DM-CLT-026** Re-abrir Guardado → Enviar → 3 alertas → Enviado _(ref potencial: 100; en home clientes: 3 botones · BD-LOCAL-OK(id=100,st=2) · BD-FIELD-OK)_
- ✅ **DM-CLT-031** Borrar cliente Guardado → desaparece de lista _("Test-CLT-DEL-647308" eliminado OK)_
