...
- ✅ **DM-CLT-024** Click Guardar → cliente potencial guardado _(alert btn: "Aceptar"; "Test-CLT-SMOKE-301255" visible en BUSCAR · BD-SAVED(st=0))_
...
- ❌ **DM-CLT-026** Re-abrir Guardado → Enviar _(Alert button no encontrado: Aceptar/OK)_
- 🚫 **DM-CLT-031** DM-CLT-031 _(CLT-026 falló)_

**Resumen:** PASS:13 · FAIL:1 · BLOCKED:1
_Tiempo: 44.8s_