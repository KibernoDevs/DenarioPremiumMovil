...
- ✅ **DM-INV-004** Seleccionar cliente _("EURO REPUESTOS FIOVAL, C.A.Código: C.0010 Saldo Bs: 2.185.44" · tabs habilitadas)_
...
- ✅ **DM-INV-011** Llenar campos modal _(cantidad: 5; expirationBatch: true; lote: LOTE-QA-3689)_
...
- ✅ **DM-INV-022** Click Enviar → Enviado _(ref: N/A · BD-LOCAL-OK(id=102,st=1) · BD-FIELD-MISMATCH (da_client_stock: payload='2026-09-14 20:32:40' vs nube='2026-09-15T00:32:40.000Z'))_
- ✅ **DM-INV-023** BUSCAR → lista _(3 ítems)_
- ✅ **DM-INV-025** Searchbar filtra _("C.0010" → 2 resultado(s))_
