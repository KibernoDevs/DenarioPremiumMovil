...
- ✅ **DM-PED-006** Seleccionar cliente → tabs habilitadas _("EURO REPUESTOS FIOVAL, C.A. (C.0010)" (vía modal, 50 clientes cargados en 0 ronda/s) · tabs libres: 4 · lockSegments: false · hasClient: true)_
...
- ✅ **DM-PED-030** Guardar pedido → confirma y el pedido queda guardado _(pregunta: "¿Desea guardar el pedido?" [Cancelar/Aceptar] → respuesta: "Pedido Guardado" [OK] · comentario: "Test-PED-584621" · en la BD local: co_order=1789433588898.0, st_delivery=3)_
...
- ✅ **DM-PED-031** Enviar pedido → llega a la nube (y UNA sola fila) _(2 alert(s): ¿Desea Enviar el pedido? [Cancelar/Aceptar] → Su Pedido será enviado [OK] · Nro.Ref: no anunciado · home tras enviar: true · ☁ 1 fila(s) con la marca Test-PED-584621: 2603/1789433588898.0 27.0000 USD st=1 · BD-OK (id_order=2603, st_delivery=1, líneas=1) · payload↔nube: BD-FIELD-MISMATCH (da_order: payload='2026-09-14 20:54:20' vs nube='2026-09-15T00:54:20.000Z') (8 POST capturado/s))_
- ✅ **DM-PED-034** BUSCAR → el searchbar filtra en tiempo real _(14 ítems → "ZZZZZZ" → 0 → al vaciar → 14)_
- ✅ **DM-PED-035** Abrir un pedido de la lista → formulario rehidratado _(tabs: General · Total · Adjunto · comentario rehidratado: "Test-PED-584621")_
...
- ⬜ **DM-PED-037** Borrar un pedido Guardado desde la lista _(sin botón de borrado en la lista (14 ítem/s): sólo los Guardado lo muestran)_
