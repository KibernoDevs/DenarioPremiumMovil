...
- ✅ **DM-VIS-015** Agregar actividad → evento con su comentario _(comentario "Test-VIS-015-0888" LEÍDO en la fila del evento · eventos: 1)_
...
- ✅ **DM-VIS-020** Click Enviar → Enviado _(alerts: [Aceptar,OK,OK] · home: true · BD-OK(id=36781,st=2,visited=true) · BD-FIELD-OK)_
- ✅ **DM-VIS-021** Back con cambios → modal 3 opciones _(opciones: [Guardar y salir, Salir sin guardar, Cancelar])_
- ✅ **DM-VIS-022** "Salir sin guardar" → visita no guardada _(salida: "Salir sin guardar" · ítems antes: 1 · después: 2)_
