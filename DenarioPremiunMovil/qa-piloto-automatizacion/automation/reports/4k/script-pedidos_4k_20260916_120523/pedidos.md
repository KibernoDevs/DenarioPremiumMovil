...
- ✅ **DM-PED-006** Seleccionar cliente → tabs habilitadas _("CASA DE REPUESTOS ISUZU MARICHES 2020, C.A. (C.0398)" (vía componente, 46 clientes cargados en 0 ronda/s) · tabs libres: 4 · lockSegments: false · hasClient: true · confirmación(es) aceptada(s): Este cliente tiene deuda vencida, ¿Desea cont [Cancelar/Aceptar])_
...
- ✅ **DM-PED-VG-001** Mapa de VGs de cabecera (selects del Tab General) _(6 select(s) con cliente (antes: 1) — Empresa="DIESEL" | Moneda="USD" | Sucursal="CTRA PETARE - SANTA LUCIA CASA" | Tipo Pedido="PEDIDO ESTANDAR" | Lista de Precio="PRECIO 1" | Condición de pago="21 DIAS")_
...
- ✅ **DM-PED-030** Guardar pedido → confirma y el pedido queda guardado _(pregunta: "¿Desea guardar el pedido?" [Cancelar/Aceptar] → respuesta: "Pedido Guardado" [OK] · comentario: "Test-PED-725372" · en la BD local: co_order=1789574729294.0, st_delivery=3)_
...
- ✅ **DM-PED-031** Enviar pedido → llega a la nube (y UNA sola fila) _(2 alert(s): ¿Desea Enviar el pedido? [Cancelar/Aceptar] → Su Pedido será enviado [OK] · Nro.Ref: no anunciado · home tras enviar: true · ☁ 1 fila(s) con la marca Test-PED-725372: 2606/1789574729294.0 27.0000 USD st=1 · BD-OK (id_order=2606, st_delivery=1, líneas=1) · payload↔nube: BD-FIELD-OK (1 POST capturado/s))_
- ✅ **DM-PED-034** BUSCAR → el searchbar filtra en tiempo real _(4 ítems → "ZZZZZZ" → 0 → al vaciar → 4)_
- ✅ **DM-PED-035** Abrir un pedido de la lista → formulario rehidratado _(tabs: General · Total · Adjunto · comentario rehidratado: "Test-PED-725372")_
...
- ⬜ **DM-PED-037** Borrar un pedido Guardado desde la lista _(sin botón de borrado en la lista (4 ítem/s): sólo los Guardado lo muestran)_
