...
(async () => {
  ...
  console.log('tipo:', await pick(pg, B+':tipoDocumento', 'Consolidado'));
  ...
  fs.writeFileSync(path.join(__dirname,'evidencia','res-FACT-ago-consol.json'),JSON.stringify(r,null,1));
  await shot(pg,'FACT-ago-consol');
  process.exit(0);
})();
