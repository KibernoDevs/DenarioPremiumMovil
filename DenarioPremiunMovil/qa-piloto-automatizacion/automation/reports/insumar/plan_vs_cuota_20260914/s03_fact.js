...
(async () => {
  ...
  await pg.evaluate(()=>{document.getElementById('form:j_idt116:dateB_input').value='01/09/2026';document.getElementById('form:j_idt116:dateF_input').value='14/09/2026';});
  ...
  fs.writeFileSync(path.join(__dirname,'evidencia','res-FACT-sep.json'),JSON.stringify(r,null,1));
  await shot(pg,'FACT-sep');
  process.exit(0);
})();
